				...
				<div id="J_main" class="g-main2" data-lazy-img-install="1">
					<div class="m-list">
						<div class="ml-wrap">
							...
							<div id="J_goodsList" class="goods-list-v2 gl-type-3 J-goods-list" data-ng-app="myApp" ng-controller="myCtrl">
								<ul class="gl-warp clearfix" ng-if="flag">
									<!--商品列表-->
									<li  class="gl-item" data-ng-repeat="x in categorie">
										<div class="gl-i-wrap">
											<div class="p-img">
												<a target="_blank" href="#" title="全店满49元起顺丰包邮 让订单飞到您的手里 详询客服">
											...
											<div class="p-name p-name-type-2">
												<a target="_blank" title="全店满49元起顺丰包邮 让订单飞到您的手里 详询客服" href="#">
